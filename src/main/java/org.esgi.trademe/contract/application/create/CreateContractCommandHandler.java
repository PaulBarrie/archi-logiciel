...
public final class CreateContractCommandHandler implements CommandHandler<CreateContract, Contract> {
    ...
    public Contract handle(CreateContract createContract) {
        ...
        Contract contract = Contract.of(contractID, createContract.getProjectID(),
                createContract.getHourlyWage(), createContract.getNbHours(), createContract.getWorkDomain());
